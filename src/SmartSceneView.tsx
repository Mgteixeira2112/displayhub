...
export default function SmartSceneView({ scene, className = '' }: { scene: SmartSceneData; className?: string }) {
  return (
    <div className={`smart-scene-player smart-scene-${scene.scene_type} smart-scene-intensity-${scene.intensity} smart-scene-motion-${scene.motion} ${className}`.trim()} data-scene-orientation={scene.orientation}>
