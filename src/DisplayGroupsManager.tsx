...
const launchStatusLabels: Record<Launch['status'], string> = { preparing: 'Preparando', armed: 'Pronto para iniciar', started: 'Em exibição', cancelled: 'Cancelado' }
